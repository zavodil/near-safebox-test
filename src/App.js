...
export default function App() {
    ...
    if (!window.walletConnection.isSignedIn()) {
        return (
            <main>
                <h1>Welcome to NEAR! Hello again Matt</h1>
                <p>
        ...
        <>
            ...
            <main>
                ...
                <form onSubmit={async event => {
                    ...
                    const {fieldset, greeting, amount} = event.target.elements
                    ...
                    try {
                        ...
                        await window.contract.deposit({
                            ...
                            hash: sha256(newGreeting),
                        },  300000000000000, ConvertToYoctoNear(newAmount))
                    } catch (e) {
                        alert(
